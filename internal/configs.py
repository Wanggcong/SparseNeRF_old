...
def define_common_flags():
  ...
  # flags.DEFINE_string('conti_flag', "True", 'Gin config files.')
  # flags.DEFINE_string('loss_weight', "0_5", 'Gin config files.')
  # flags.DEFINE_string('loss_weight2', "0_0", 'Gin config files.')
...
def load_config(save_config=True):
  ...
  # config.conti_flag = flags.FLAGS.conti_flag  
  # config.loss_weight = flags.FLAGS.loss_weight  
  # config.loss_weight2 = flags.FLAGS.loss_weight2  

  # print('######### flags.FLAGS:',flags.FLAGS.checkpoint_dir)
  if True:
  ...
  # print('######### config:',config.checkpoint_dir)
